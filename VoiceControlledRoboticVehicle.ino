// Five in One Robot Car by Technical Gudachari
...
long IRremote_data(){
     if(results.value==0x1FE609F){IR_data=1;}  
else if(results.value==0x1FEA05F){IR_data=2;} 
else if(results.value==0x1FE40BF){IR_data=3;} 
else if(results.value==0x1FEC03F){IR_data=4;} 
else if(results.value==0x1FE48B7 || results.value==0x1FE48B7){IR_data=5;} 
else if(results.value==0x1FE906F){IR_data=8;} 
else if(results.value==0x1FE807F){IR_data=9;} 
else if(results.value==0x1FE10EF){IR_data=10;} 
return IR_data;
}
